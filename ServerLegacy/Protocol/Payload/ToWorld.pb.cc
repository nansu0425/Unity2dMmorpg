...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_ToWorld_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_ToWorld_2eproto = nullptr;
const ::uint32_t
    TableStruct_ToWorld_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_ToWorld_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\rToWorld.proto\022\005proto\032\014Common.proto\"7\n\027"
    "ClientToWorld_EnterRoom\022\n\n\002id\030\001 \001(\003\022\020\n\010p"
    "assword\030\002 \001(\t\"1\n\022ClientToWorld_Chat\022\n\n\002i"
    "d\030\001 \001(\003\022\017\n\007message\030\002 \001(\tb\006proto3"
};
static const ::_pbi::DescriptorTable* const descriptor_table_ToWorld_2eproto_deps[1] =
    {
        &::descriptor_table_Common_2eproto,
};
static ::absl::once_flag descriptor_table_ToWorld_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_ToWorld_2eproto = {
    false,
    false,
    152,
    descriptor_table_protodef_ToWorld_2eproto,
    "ToWorld.proto",
    &descriptor_table_ToWorld_2eproto_once,
    descriptor_table_ToWorld_2eproto_deps,
    1,
    2,
    schemas,
    file_default_instances,
    TableStruct_ToWorld_2eproto::offsets,
    file_level_enum_descriptors_ToWorld_2eproto,
    file_level_service_descriptors_ToWorld_2eproto,
};
namespace proto {
// ===================================================================
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_ToWorld_2eproto),
         ::std::false_type{});
