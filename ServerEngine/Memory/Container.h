...
using String8   = std::basic_string<Char8, std::char_traits<Char8>, ContainerAllocator<Char8>>;
using String16  = std::basic_string<Char16, std::char_traits<Char16>, ContainerAllocator<Char16>>;
