/*    ServerProtocol/Network/Packet.h    */

#pragma once
#include "ServerProtocol/Network/C2S_Payload.pb.h"
#include "ServerProtocol/Network/S2C_Payload.pb.h"
...
#pragma pack(pop)
    ...
    public:
         ...
         */
        explicit Packet(SharedPtr<core::Session> owner, const Byte* buffer)
    ...
    public:
        ...
        static SharedPtr<core::SendBuffer> MakePacketBuffer(const TPayload& payload, PacketId packetId)
        {
         ...
         */
        static Int64    ProcessPackets(PacketHandlerMap& handlers, SharedPtr<core::Session> owner, const Byte* buffer, Int64 numBytes);
    };
} // namespace protocol
