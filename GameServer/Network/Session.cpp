...
void GameSession::OnPacketReceived(Byte* message, Int64 size)
{
    // 메시지 처리
    gMessageHandlerManager.HandleMessage(std::static_pointer_cast<GameSession>(shared_from_this()), message, size);
}
